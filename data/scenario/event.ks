...
*ev_d1_r1_p4
    ...
    郵便受けだ。[p]
    どうやらチラシが入って………[l]
    [image storage="ev_img/ev_d1_r1_p4.png" layer="0" name="ev_img" x=0 y=0 width=1280 visible=true time="500"]
    …ガスの領収書が入っている。
    [l][r]………思ったより高いな。[p][cm]
...
*ev_d1_r1_p5
    ...
    [endscript]
    [if exp="tf.isFirst"]
        [if exp="f.searchFlg_day1[1][4] <= 1"]
            [image storage="ev_img/ev_d1_r1_p5.png" layer="0" name="ev_img" x=0 y=0 width=1280 visible=true time="500"]
            #
            …ガスの領収書が入っている。
            [l][r]………思ったより高いな。[p][cm]
            [free name="ev_img" layer="0"]
...
*ev_d1_r6_p6
    ...
    [endscript]
    [if exp="tf.isFirst"]
    [image storage="ev_img/ev_d1_r6_p6.png" layer="0" name="ev_img" x=0 y=0 width=1280 visible=true time="500"]
    #
    写真の向こうで笑っている。[p]
    楽しそうな笑顔だ。[p]
...
*ev_d1_r6_p7
    ...
    [endscript]
    [if exp="tf.isFirst"]
    [image storage="ev_img/ev_d1_r6_p7.png" layer="0" name="ev_img" x=0 y=0 width=1280 visible=true time="500"]
    #
...
*ev_d1_r6_p8
    ...
    [endscript]
    [if exp="tf.isFirst"]
    [image storage="ev_img/ev_d1_r6_p8.png" layer="0" name="ev_img" x=0 y=0 width=1280 visible=true time="500"]
    #
    写真立てが倒れている。[p]
