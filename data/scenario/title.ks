...
[button name="my_btn" role="sleepgame" graphic="button/noon_config.png" enterimg="button/noon_config2.png" storage="config.ks" clickse="sei_ge_bubble01.mp3" x="10" y="590"]
